...
# MAGIC %md
# MAGIC # Fine tune `mistral_7b_v0_1` model from marketplace with QLORA
# MAGIC
# MAGIC Databricks hosts the `mistral_7b_v0_1` in [Databricks marketplace](https://marketplace.databricks.com/). This is a tutorial to show how to fine tune the models on the [mosaicml/dolly_hhrlhf](https://huggingface.co/datasets/mosaicml/dolly_hhrlhf) dataset.
# MAGIC
...
%pip install --upgrade "mlflow-skinny[databricks]==2.8.0"
...
# MAGIC
# MAGIC In this section we will load the [mistral_7b_v0_1](https://huggingface.co/mistralai/Mistral-7B-v0.1) model installed from [Databricks marketplace](https://marketplace.databricks.com/) saved in Unity Catalog to local disk, quantize it in 4bit and attach LoRA adapters on it.
